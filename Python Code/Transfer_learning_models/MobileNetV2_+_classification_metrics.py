...
path_data_source="/your_data_source_path/"
test_dir = "/your_test_patj/"
...
def results (model,test_data,dataset,name):
    ...
    plt.savefig(path_destination+"cf_matrix_fig_mobilenet_"+str(dataset)+"_"+str(name)+".png")
...
def training_plots(datasets,name):
    ...
    for  j in range (len (datasets)):
        ...
        plt.savefig(path_destination+"_val_accuracy_mobilenet_" + str(j)+"_" + str(name)+ ".png")
        plt.show()
...
def training_results_fine (datasets,name):
    ...
    for  j in range (len (datasets)):
        ...
        #plt.legend(["train", "validation"], loc="upper left")
        plt.show()
        fig.savefig(path_destination+"val_accuracy_fine_mobilenet_" + str(j)+ ".png")
...
for j in datasets:
    ...
    for i in epochs_vector:
        ...
        model.save(path_destination+"mobilenet" + "_test1_" + str(j))
        model.save(path_destination+"mobilenet_h" + "_test1_"  + str(j) + ".h5")
...
for j in datasets:
    ...
    for i in epochs_vector:
        for l in unfreeze_layers:
            ...
            model.save(path_destination+"mobilenet" + "_test2_" + str(j))
            model.save(path_destination+"mobilenet_h" + "_test2_"  + str(j) + ".h5")
...
for j in datasets:
    ...
    for i in epochs_vector:
        for l in unfreeze_layers:
            ...
            model.save(path_destination+"mobilenet" + "_test3_" + str(j))
            model.save(path_destination+"mobilenet_h" + "_test3_"  + str(j) + ".h5")

training_results_fine(datasets,"test3")
df.to_csv(path_destination+"mobilenet.csv", index=False)
